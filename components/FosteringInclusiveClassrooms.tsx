    ...
    <div className="my-3 space-y-4">
      ...
      <div>
              ...
              <div className="mt-3">
                ...
                <p className="ml-4">Addressing historical and ongoing systemic inequalities to ensure fair access and opportunities for all. We must create conditions that address systemic barriers to participation and success.</p>
              </div>
              
              <div className="mt-3">
                <p className="font-medium">Diversity:</p>
                <p className="ml-4">Recognizing and valuing the diverse backgrounds, experiences, and identities of all individuals in our community.</p>
              </div>
              
              <div className="mt-3">
                <p className="font-medium">Inclusion:</p>
                <p className="ml-4">Creating a sense of belonging and engagement where everyone feels valued and respected – that they matter!</p>
              </div>
              
              <div className="mt-3">
                <p className="font-medium">Accessibility:</p>
                <p className="ml-4">Ensuring that all members of the university community, including those with disabilities (including physical), have equal access to resources and opportunities. This means access to physical spaces, digital resources, and programming accessible to all. We need to ensure that all students, regardless of disability or need, can fully engage with course materials and learning activities.</p>
              </div>
              
              <p className="mt-4">
                In essence, EDIA at Dalhousie is about creating a community where everyone feels valued, respected, and has the opportunity to thrive, regardless of their background or identity.
              </p>
              
              <p className="mt-4">
                You can explore Dalhousie's full EDIA framework and strategic goals here: <a href="https://www.dal.ca/about/mission-vision-values/equity-diversity-inclusion-and-accessibility.html" className="text-blue-800 underline inline-flex items-center" target="_blank">Dalhousie EDIA Commitments<ExternalLink className="ml-1 h-4 w-4" /></a>
              </p>
            ...
            <div>
              <h3 className="font-bold mb-2">Practical Strategies for Inclusive Teaching</h3>
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc pl-6 space-y-1 mt-2">
                  ...
                  <li>Refer to Dalhousie's <a href="https://www.dal.ca/about/mission-vision-values/respectful-discourse.html" className="text-blue-800 underline inline-flex items-center" target="_blank">Respectful Discourse Guidelines.<ExternalLink className="ml-1 h-4 w-4" /></a></li>
                </ul>
              </div>
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc pl-6 space-y-1 mt-2">
                  <li>Use the<a href="https://caul-cbua.pressbooks.pub/creatingaccessiblelearningresources/" className="text-blue-800 underline inline-flex items-center" target="_blank"> Creating Accessible Learning Resources: A Practical Guide<ExternalLink className="ml-1 h-4 w-4" /></a> to help you learn how to create accessible learning resources, high-contrast visuals, captioned videos, and screen-reader-friendly documents.</li>
              ...
              <div className="mt-4">
                <h4 className="font-semibold">Curriculum Representation and Content</h4>
                <ul className="list-disc pl-6 space-y-1 mt-2">
            ...
            <div>
              <h3 className="font-bold mb-2">Supporting Mental Health and Wellness in the Classroom</h3>
              <p className="mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                <li>If a wellness statement and/or resource list has been shared in the course syllabus, be sure to direct students to it or the supports listed below.</li>
                <li>Remind students that it's okay to ask for help and that Dalhousie has confidential and free support available to them.</li>
                <li>Be flexible with deadlines where reasonable; rigidity can disproportionately harm students who may need extra time due to health concerns or those with accommodation plans.</li>
              </ul>
              
              <h4 className="font-semibold mt-4">Resources you can share:</h4>
              <ul className="list-disc pl-6 mt-2">
                <li><a className="text-blue-800 underline inline-flex items-center" target="_blank" href="https://www.dal.ca/campus_life/health-and-wellness/my-health/mental-health.html">Mental Health Supports<ExternalLink className="ml-1 h-4 w-4" /></a></li>
                <li><a className="text-blue-800 underline inline-flex items-center" target="_blank" href="https://dalu.sharepoint.com/sites/hr/SitePages/wellness.aspx">Wellness Hub for Staff and Faculty<ExternalLink className="ml-1 h-4 w-4" /></a></li>
              </ul>
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                ...
                <p>
                As a TA or Demonstrator, you hold power in the classroom—often more than you realize. Being mindful of that power dynamic means avoiding public callouts unless necessary, i.e., where a situation in the learning environment may cause undue harm to another individual or groups of individuals. Read <a href="https://edib.harvard.edu/files/dib/files/calling_in_and_calling_out_guide_v4.pdf" className="text-blue-800 underline inline-flex items-center" target="_blank">Harvard’s Calling In and Calling Out Guide <ExternalLink className="ml-1 h-4 w-4" /></a>to familiarize yourself with what to do in specific situations where inappropriate behaviours in a learning space need to be addressed.                   
                </p>
                ...
                <ul className="list-none pl-1 space-y-2 mt-2">
                  <li>📩 Contact the Student Support Team: <a  href="https://dalu.sharepoint.com/sites/shw/SitePages/Student-Support-Team.aspx" className="text-blue-800 underline inline-flex items-center" target="_blank">Student Support Team<ExternalLink className="ml-1 h-4 w-4" /></a></li>
                  <li>📚 Explore Dalhousie EDIA Resources: <a target="_blank" href="https://www.dal.ca/about/mission-vision-values/equity-diversity-inclusion-and-accessibility.html" className="text-blue-800 underline inline-flex items-center">EDIA Resources<ExternalLink className="ml-1 h-4 w-4" /></a></li>
                  <li>🧠 Share Mental Health Resources: <a target="_blank" href="https://www.dal.ca/campus_life/health-and-wellness/my-health/mental-health.html" className="text-blue-800 underline inline-flex items-center">Mental Health Resources<ExternalLink className="ml-1 h-4 w-4" /></a></li>
                </ul>
              </div>
            </div>
        </div>
