...
const BloomsTax = () => {
  return (
    <div className="mt-3 space-y-2">
      <p>
        As a Teaching Assistant (TA) in the Faculty of Computer Science, part of
        your role may involve supporting instructors in the development or
      ...
      <div className="flex flex-row">
        <div className="space-y-1 flex-1">
          ...
          <ol className="list-decimal pl-6 space-y-1.5 my-2">
            <li>
              <strong>Remember</strong>– Recall facts and basic concepts (e.g.,
              define, list)
            </li>
            <li>
              <strong>Understand</strong>– Explain ideas or concepts (e.g.,
              describe, summarize)
            </li>
            <li>
              <strong>Apply</strong>– Use information in new situations (e.g.,
              implement, solve)
            </li>
            <li>
              <strong>Analyze</strong>– Draw connections among ideas (e.g.,
              differentiate, debug)
            </li>
            <li>
              <strong>Evaluate</strong>– Justify a decision or position (e.g.,
              critique, recommend)
            </li>
            <li>
              <strong>Create</strong>– Produce new or original work (e.g.,
              design, develop)
            </li>
          </ol>

          <p>
            This hierarchy supports the design of tasks that move beyond
            memorization and foster deeper learning, particularly important in
            computer science where problem-solving, analysis, and creation are
            essential skills.
          </p>
        </div>
      ...
      <ul className="list-disc pl-6 space-y-2 mt-2 ">
        <li>
          <i>
            “Students will be able to debug a recursive function to identify
            logical errors.”
          </i>{" "}
          (Analyze)
        </li>
        <li>
          <i>
            “Students will design and implement a simple RESTful API using
            Flask.”
          </i>{" "}
          (Create, Apply)
        </li>
      ...
      <p>
        Avoid vague outcomes like <i>“understand recursion” </i> — instead,
        specify what students should be able to do with that understanding.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2 mt-2">
        ...
        <li>
          <strong>Use scaffolded tasks</strong>. Start with recall or
          application-based exercises and build toward more complex analysis or
          design problems.
        </li>
        <li>
...
const bloomsData = [
  ...
  },
  {
    ...
    task: "Compare the performance of quicksort and mergesort on large datasets and discuss the results.",
  },
  {
    level: "Create",
    outcome: "Design and implement a simple RESTful API using Flask.",
    task: "Build a RESTful API for a to-do list application, including endpoints for creating, reading, updating, and deleting tasks.",
  },
];
      ...
      <table className="min-w-full border border-gray-300 text-left">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th className="border px-4 py-2 font-semibold">
              Example Assignment or Lab Task
            </th>
          </tr>
        </thead>
        <tbody>
