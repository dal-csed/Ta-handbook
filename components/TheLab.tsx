...
export default function TheLab() {
  ...
  return (
    <div className="my-3 space-y-4">      
      ...
      <div className="my-4">
        <h3 className="font-bold text-lg">Creating a Sense of Belonging for Students</h3>
        ...
        <ul className="list-disc pl-6 space-y-2 mt-2">
          <li>Start by sharing your name and the names of any Demonstrators in the room. Share something about yourself with your students. Perhaps your course of study, where you are from, your favourite hobby, etc. Even something about your own journey as a CS student. This helps students get to know you and develops a sense of familiarity.</li>
          <li>Remind your students that, as a TA, your role is to support their learning, which means approaching interactions differently than you would as a peer.</li>
          <li>You need to make an effort to learn students' names. A good way of doing this is to have students write their names on labels and wear them on their lapel the first couple of classes or create name tents (folding a piece of paper in half, students write their names on one half, then prop up the paper next to them). Also, encourage students to share their names with other students when they engage with each other for paired or group work.</li>
          <li>If a student asks a clarifying question after a demonstration or if it is relevant for the whole class, repeat it for everyone in the class to hear before you respond.</li>
          <li>Use students' names when speaking to them. If you do not know it, ask them and then repeat it before you respond. "Great question, Ammar….."</li>
        </ul>
      </div>
      ...
      <div className="my-4">
        ...
        <p className="mt-2">
          The University of Michigan's CRLT page on lab teaching provides a range of resources designed to assist TAs in effectively teaching laboratory classes. Some of these resources aim to enhance instructional practices and support TAs in creating an engaging and productive learning environment that can also be effective in the computer science context. Key materials include guidelines for preparing to teach lab sections, checklists for logistics, sample syllabi, strategies for effective teaching, and best practices for grading laboratory reports. The resources aim to enhance instructional practices and support TAs in creating an engaging and productive learning environment. 
        </p>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          {activeTab === "considerations" && (
            <div>
              <p>
                When Teaching Assistants (TAs) in Computer Science are responsible for lab classes, there are several important considerations to keep in mind to ensure a smooth and productive learning environment. Here's a breakdown of the key areas to focus on:
              </p>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Make sure that all required software is installed, configured, and updated before the lab session.</li>
                <li>Verify that hardware components are functioning properly if you need them (this includes audio/visual equipment).</li>
              </ul>
              
              <p className="font-medium mt-2">Backup and Recovery Plans:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Prepare contingency plans in case of technical failures (e.g., server crashes or corrupted files). Also, if students experience issues with their laptops, one can be borrowed from the CS Help Desk on the first floor of the Goldberg. Student ID is required.</li>
                <li>Keep backup copies of essential software and data and know how to restore the environment quickly.</li>
              </ul>
              
              <p className="font-medium mt-2">Lab Environment Consistency:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Ensure that all students receive the same information regarding what it is they need to access/download either before or at the beginning of the lab to avoid confusion.</li>
              </ul>
              
              <h4 className="font-semibold mt-4">2. Clear Instructions and Demonstrations</h4>
              
              <p className="font-medium mt-2">Lab Introduction:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Start each session with a brief overview of the objectives and tasks for the day.</li>
                <li>Clearly explain the expected outcomes and deliverables (introduce any rubrics and exemplars at this time if you have them).</li>
              </ul>
              
              <p className="font-medium mt-2">Demonstrations:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Demonstrate essential skills or concepts and specific programming functions, especially those that students may struggle with, such as debugging techniques.</li>
                <li>Use visual aids, code snippets, and live coding to make explanations clear and engaging.</li>
              </ul>
              
              <p className="font-medium mt-2">Written Guidelines:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Provide step-by-step instructions or handouts that students can refer to during the lab.</li>
                <li>Make sure these documents are available digitally through the learning management system (LMS). This helps with accessibility as students can enlarge the text or use screen readers.</li>
              </ul>
              
              <h4 className="font-semibold mt-4">3. Supporting Student Learning</h4>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Be prepared to troubleshoot common errors, such as compilation issues, dependency conflicts, or network failures.</li>
                <li>Have a list of common problems and their solutions readily available.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Emphasize the importance of protecting personal data and adhering to privacy regulations when working with datasets.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Ensure that students are aware of ergonomics to reduce strain during long coding sessions. Adjustable seats, standing to take a stretch etc.</li>
                <li>Although there aren’t harmful chemicals to deal with in computer science labs, it is important to take into account the <strong>physical environment</strong>. Encourage students to be mindful of trailing laptop cables, tucking backpacks under tables and placing jackets on the backs of seats. These are all possible <strong>tripping hazards</strong>; keeping the space organized can help prevent accidents. </li>
                <li>Promote good practices like taking short "<strong>Bio-breaks</strong>!" to reduce screen fatigue and allow the students to stretch their legs, use the washroom, get a drink of water, etc.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Be consistent and fair when assessing student work, following clearly defined rubrics. If you aren’t grading the work, you still need to be aware of how the piece of work is assessed and be able to explain this to the students.  </li>
                <li>Offer constructive feedback that highlights both strengths and areas for improvement. If needed, highlight to the student where they can revise the topic (Module 2, topic 3) or include a video link in written responses.</li>
              </ul>
              
              <p className="font-medium mt-2">Student Reflection:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Encourage students to reflect on their learning after each lab and discuss what they found challenging or insightful. If they need to improve in a certain area, they should know where to find resources and make a plan to learn it. </li>
              </ul>
              
              <h4 className="font-semibold mt-4">7. Communication and Professionalism</h4>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Be punctual, prepared, and responsive to student inquiries.</li>
                <li>Maintain confidentiality and respect students' privacy when discussing grades or performance.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Summarize key takeaways and reinforce the learning objectives at the end of each session.</li>
              </ul>
              
              <p className="font-medium mt-2">Post-Lab Support:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Make yourself available for follow-up questions during office hours or through online forums (if that time has been allocated to you by the instructor).</li>
                <li>Share recorded demonstrations, additional resources or further practice problems on the LMS (Brightspace).</li>
              </ul>
            </div>
          )}
